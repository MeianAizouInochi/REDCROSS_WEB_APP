...
const Tcprivacypoilcy = () => {
    ...
    return (
        <div className="tcprivacypolicycontainer">
            <div className="tcprivacypolicysubcontainer">
                <div className="tcprivacypolicyheadingcontainer">
                    <p><strong>Terms and conditions</strong></p>
                </div>
                <div className="tcprivacypolicybodycontainer">
...
export default Tcprivacypoilcy;